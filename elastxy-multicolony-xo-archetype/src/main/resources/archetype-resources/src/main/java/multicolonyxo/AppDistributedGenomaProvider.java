 ...
 * @author red
 */
public class AppDistributedGenomaProvider implements DistributedGenomaProvider {
	private static Logger logger = Logger.getLogger(AppDistributedGenomaProvider.class);
